...
public class EmployeesDao {
    ...
    public Employees loginQuery(String user,String password){
        ...
        try{
            ...
            if (rs.next()){
                ...
                adress_user = employee.getAdress();
            ...
            JOptionPane.showMessageDialog(null,"Erro al obtener al empleado " + e);
    ...
    public boolean registerEmployeeQuery(Employees employee){
        String query ="INSERT INTO employees(id,full_name,username,adress,"
        ...
        try{
            ...
            pst.setString(4,employee.getAdress());
    ...
    public boolean updateEmployeeQuery(Employees employee){
        String query ="UPDATE employees SET full_name=?,username=?,adress=?,"
                + "telephone=?,email=?,rol=?,updated=?  WHERE id=?";
        Timestamp datetime = new Timestamp(new Date().getTime());
